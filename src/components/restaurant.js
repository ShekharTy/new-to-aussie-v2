      ...
      <div className="body flex flex-col items-center mt-8 ml-64">
            <div className="bg-gray-200 p-4 w-3/4 rounded-lg shadow-lg">
              <ul className="mt-4 grid grid-cols-2 gap-4">
                <li
                  className={`cursor-pointer bg-white rounded-md shadow-lg p-4 ${
        ...
        <>
          ...
          <div className="search-bar flex flex-col mt-8 items-center">
            <div className="mb-4">
              <label
                htmlFor="cuisine"
                className="mr-4 text-lg text-blue-800 font-bold"
              >
          ...
          <div className="filtered-restaurants mt-6">
            <h2 className="text-xl font-bold mb-2">
              {" "}
              List of restaurants with preferred cuisine and suburb below!
            </h2>
            <div
              className="grid grid-cols-4 gap-4 animate__animated animate__fadeInUp"
              style={{ backgroundColor: "#EFFEFC" }}
            >
          ...
          {filteredRestaurants.length === 0 &&
            ...
            selectedSuburb && (
              <div className="filtered-restaurants mt-6">
                <h2 className="text-xl font-bold mb-2">
                  No restaurants found with the selected cuisine in the selected
                  suburb!
                </h2>
              </div>
            )}
